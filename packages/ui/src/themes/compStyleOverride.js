    ...
    MuiListItemButton: {
      styleOverrides: {
        root: {
          ...
          paddingTop: "10px",
          paddingBottom: "10px",
          "&.Mui-selected": {            // colors of selected item from menuItems
            color: theme.menuSelected,
            backgroundColor: theme.menuSelectedBack,
            "&:hover": {
              backgroundColor: theme.menuSelectedBack,
              "& .MuiListItemIcon-root": {          // color of selected item (icon) on hover
                // color: theme.menuSelected,
                color: "#FFF860",
              },
            },
            "& .MuiListItemIcon-root": {          // color of selected item (icon)
              // color: theme.menuSelected,
              color: "#FFF860",
            },
          },
    ...
    MuiInputBase: {
      styleOverrides: {
        input: {
          ...
          "&.Mui-disabled": {
            WebkitTextFillColor: theme?.customization?.isDarkMode
              ? theme.colors?.grey500
